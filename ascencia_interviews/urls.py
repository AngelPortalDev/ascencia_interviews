    ...
    path(
        ...
        include(
            [
                ...
                path(
                    "institute/update/<id>/", institute_update, name="institute_update"
                ),
                path(
                    "institute/delete/<id>/", institute_delete, name="institute_delete"
                ),
                # courses
                ...
                path(
                    "common_question/add",
                    common_question_add,
                    name="common_question_add",
                ),
                path(
                    "common_question/update/<id>/",
                    common_question_update,
                    name="common_question_update",
                ),
                path(
                    "common_question/delete/<id>/",
                    common_question_delete,
                    name="common_question_delete",
                ),
                # questions
